(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-simple-toast"] = factory();
	else
		root["vue-simple-toast"] = factory();
})(this, function() {
...
var DEFAULT_COLOR_SUCCESS = '#1AB394';
var DEFAULT_COLOR_ERROR = '#ED5565';
var DEFAULT_COLOR_WARNING = '#F8AC59';
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
    color: {
      ...
      validator: function validator(value) {
        return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' ? value.success || value.error || value.warning : typeof value === 'string';
      }
    },
    message: {
      type: String,
  ...
  computed: {
    colorSuccess: function colorSuccess() {
      var color = this.color;

      if ((typeof color === 'undefined' ? 'undefined' : _typeof(color)) !== 'object') {
        return color || DEFAULT_COLOR_SUCCESS;
      }
      return color.success ? color.success : DEFAULT_COLOR_SUCCESS;
    },
    colorWarning: function colorWarning() {
      var color = this.color;

      if ((typeof color === 'undefined' ? 'undefined' : _typeof(color)) !== 'object') {
        return color || DEFAULT_COLOR_WARNING;
      }
      return color.warning ? color.warning : DEFAULT_COLOR_WARNING;
    },
    colorError: function colorError() {
      var color = this.color;

      if ((typeof color === 'undefined' ? 'undefined' : _typeof(color)) !== 'object') {
        return color || DEFAULT_COLOR_ERROR;
      }
      return color.error ? color.errpr : DEFAULT_COLOR_ERROR;
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__simple_toast_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__simple_toast_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__simple_toast_vue__);
...
function install(Vue) {
  ...
  Vue.component('simpleToast', __WEBPACK_IMPORTED_MODULE_0__simple_toast_vue___default.a);
}
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__simple_toast_vue___default.a);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "message"
  }, [_vm._v(_vm._s(_vm.toastMessage))]), _vm._v(" "), (_vm.dismissible) ? _c('span', {
    staticClass: "dismiss",
    on: {
      "click": _vm.dismiss
    }
